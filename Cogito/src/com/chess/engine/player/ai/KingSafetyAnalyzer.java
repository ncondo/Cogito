...
public final class KingSafetyAnalyzer {
	...
	public KingDistance calculateKingTropism(final Player player) {
		...
		for (final Move move : enemyMoves) {
			final int currentDistance = calculateChebyshevDistance(playerKingSquare,
	...
	private int calculateChebyshevDistance(final int pieceOneSquare, final int pieceTwoSquare) {
